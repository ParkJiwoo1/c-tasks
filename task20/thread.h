...
/* added code */
#define sock_set_t fd_set
#define MTYPE_THREAD_MASTER 1
#define MTYPE_THREAD 1
...
#define THREAD_PRIORITY_LOW          2
	...
	struct timeval stime;  /* Timer's absolute starting time. */
	struct timeval period; /* Timer's period. */
#endif /* HAVE_HA */
};
